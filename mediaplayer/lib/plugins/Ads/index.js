...
var AdsPlugin = /** @class */ (function () {
    ...
    AdsPlugin.prototype.renderAd = function () {
        ...
        this.currentAd = ad;
        this.adsContainer.innerHTML = "\n      <div class=\"ads\">\n        <a class=\"ads__link\" href=\"".concat(this.currentAd && this.currentAd.url, "\" target=\"_blank\">\n          <img class=\"ads__img\" src=\"").concat(this.currentAd && this.currentAd.imageUrl, "\" />\n          <div class=\"ads__info\">\n            <h5 class=\"ads__title\">").concat(this.currentAd && this.currentAd.title, "</h5>\n            <p class=\"ads__body\">").concat(this.currentAd && this.currentAd.body, "</p>\n          </div>\n        </a>\n      </div>\n    ");
        setTimeout(function () {
